                  ...
                  <div class="cc-l-wrap">
                    ...
                    <section class="mt10 hLh20 of">
                      <span
                        ...
                        v-if="Number(course.viewCount) > 10"
                      >
                        <i class="c-fff fsize12 f-fA">热门</i>
                      </span>
                      <span class="fl jgAttr c-ccc f-fA">
                        <i class="c-999 f-fA">{{ course.viewCount }}观看</i>
                        |
                        <i class="c-999 f-fA">{{ course.buyCount }}收藏</i>
                      </span>
                    </section>
                  </div>
                </li>
                ...
                <li v-for="teacher in teacherList" :key="teacher.id">
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a @click="gotoTeacher(teacher.id)" :title="teacher.name">
